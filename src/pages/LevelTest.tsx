...
export default function LevelTest() {
  ...
  const [currentStep, setCurrentStep] = useState<"intro" | "test" | "result">(
    "intro",
  );
  ...
  const finishTest = async () => {
    ...
    const analysis = await getAIFeedback(
      prompt,
      "Level Test Analysis",
      finalLevel,
    );
      ...
      <div className="max-w-3xl mx-auto">
        {currentStep === "intro" && (
          <motion.div
            ...
            className="bg-white p-12 rounded-6xl border border-zinc-100 shadow-2xl text-center"
          >
        ...
        {currentStep === "test" && (
          <div className="space-y-8">
            <div className="flex justify-between items-center px-4">
              <h2 className="text-xs font-black uppercase tracking-widest text-[#58007E]">
            ...
            <div className="space-y-6">
              {levelQuestions.map((q, idx) => (
                <motion.div
                  ...
                  key={q.id}
                  className="bg-white p-8 rounded-4xl border border-zinc-100 shadow-sm"
                >
          ...
          >
            <div className="bg-[#58007E] p-12 rounded-[48px] text-white text-center shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <h2 className="text-8xl font-black italic mb-4">
                  {levelResult}
                </h2>
                <p className="text-indigo-100 font-medium">
                  Excellent work completing the assessment!
                </p>
              </div>
                ...
                {isAnalyzing ? (
                  <div className="flex items-center gap-2 text-zinc-400">
                    <motion.div
                      ...
                      className="w-4 h-4 border-2 border-[#58007E] border-t-transparent rounded-full"
                    />
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 py-5 rounded-2xl border-2 border-zinc-100 font-black text-xs uppercase tracking-widest hover:border-zinc-300 transition-all"
              >
                Retake Test
              </button>
              <button
