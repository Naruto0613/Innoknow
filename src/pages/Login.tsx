    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4 bg-[#FDFCFB]">
      ...
      >
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-indigo-600 rounded-2xl mx-auto flex items-center justify-center text-white font-black text-3xl mb-4 shadow-xl shadow-indigo-100 italic">
            I
          </div>
