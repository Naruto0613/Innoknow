      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative z-10 bg-white p-4 rounded-[40px] shadow-2xl border border-zinc-100">
               <img 
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-black uppercase text-zinc-400">Success Rate</p>
