  ...
  const team: Teammate[] = [
    {
      ...
      photoSeed: "badral",
      details:
        "МУИС болон ШУТИС-ийн Мэдээллийн Технологийн сургууль төгссөн. INNOKNOW академийн Gemini AI болон яриа гүйцэтгэх системийг хариуцан хөгжүүлсэн эрдэмтэн хөгжүүлэгч.",
    ...
    },
    {
      ...
      details:
        "МУИС болон ШУТИС-д суралцаж, олон улсын хэлний чиглэлээр мэргэшсэн. Түвшин бүрт тохирох 50 прогрессив хичээлийг урагшлуулах удирдамжийн загварыг боловсруулсан үүсгэн байгуулагч.",
    ...
    },
    {
      ...
      photoSeed: "nomin",
      details:
        "Олон улсын хэрэглэгчийн туршлага судлалын багт ажиллаж байсан. Тэргүүлэгчдийн лидерийн хуудас болон гүйцэтгэлийн анализуудыг урласан шинийг санаачлагч.",
    ...
    },
    {
      ...
      photoSeed: "sarnai",
      details:
        "МУБИС-ийг Гадаад хэлний багш мэргэжлээр төгссөн. Оюутнуудын ярианы чадварыг хурдавчилсан аргаар сайжруулах, сэтгэл зүйн бэлтгэл хангахад мэргэшсэн. INNOKNOW-ийн ухаалаг үнэлгээний дасгалууд бэлтгэдэг.",
    ...
    },
    {
      ...
      photoSeed: "anand",
      details:
        "МУИС-ийн Бизнесийн сургуулийг төгссөн. Олон нийтэд технологи хэрэгцээт сургалтыг ухаалаг, хөгжилтэй хэлбэрээр таниулах сурталчилгааны стратеги удирдан ажилладаг.",
      ...
      <div className="max-w-5xl mx-auto space-y-24">
        ...
        <header className="text-center space-y-6 pt-8">
          ...
          <p className="max-w-2xl mx-auto text-sm md:text-base text-slate-500 leading-relaxed font-semibold">
            Бид англи хэлний танхимын хуучинсаг сургалтын загварыг бүрэн халж,
            хиймэл оюуны хүчин чадлыг ашиглан хэрэглэгч бүрт тохирсон
            сонирхолтой, хамгийн богино хугацаанд бодит ахиц өгөх шинэлэг
            системийг хөгжүүлж байна.
          </p>
        </header>

        {/* Section 1: Our Story - Center Aligned */}
        <section className="text-center space-y-6">
          <h2 className="text-3xl font-black font-serif italic text-slate-900 tracking-tight">
            Бидний Түүх
          </h2>
          <div className="max-w-3xl mx-auto bg-white p-8 md:p-10 rounded-5xl border border-zinc-100 shadow-sm text-sm text-zinc-600 font-medium leading-relaxed space-y-4">
            <p>
              INNOKNOW-ийн суурь нь анх 2024 онд хэлний болон технологийн
              мэргэжилтнүүд хамтран ухаалаг орчныг бүрдүүлэхээр нэгдсэнээр
              тавигдсан юм. Бид Монгол сурагчид англиар чөлөөтэй ярихад
              тулгардаг уламжлалт бэрхшээл болох сургалтын материалын хомсдол,
              бодит ярианы дадлага хийх боломжгүй орчин зэргийг олж харсан.
            </p>
            <p>
              Gemini AI болон хэл шинжлэлийн дэвшилтэт онол дээр суурилсан
              хамгийн анхны ярианы дадлагажуулагчийг бүтээж, түүнийгээ өнөөдрийн
              50 прогрессив сорилт бүхий цогц систем болгон өргөжүүлсэн. Энэхүү
              замнал нь манай сурагчдын амжилт бүрээр баяжигдаж байна.
            </p>
          </div>
        </section>
        ...
        <section className="text-center space-y-8">
          <div>
            <span className="text-[10px] font-black uppercase text-zinc-400 tracking-widest block mb-2">
              БҮТЭЭГЧИД
            </span>
            <h2 className="text-3xl font-black font-serif italic text-slate-900 tracking-tight">
            ...
            <p className="text-xs text-zinc-500 font-bold max-w-md mx-auto mt-2">
              Юу сурч байгаадаа эзэн болоход чинь туслах манай удирдагчидтай
              танилц. Кард дээр дарж дэлгэрэнгүй намтар уншина уу.
            </p>
          </div>
            ...
            {team.map((partner) => {
              ...
              return (
                <button
                  key={partner.name}
                  onClick={() =>
                    setSelectedPartner(isSelected ? null : partner)
                  }
                  className={`p-6 rounded-4xl border text-center bg-white transition-all cursor-pointer relative ${
                    isSelected
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="text-center">
                      <h4 className="text-xs font-black text-slate-800 uppercase tracking-tight text-center">
                        {partner.name}
                      </h4>
          ...
          <AnimatePresence>
            {selectedPartner && (
              <motion.div
                ...
                className="p-8 bg-[#58007E]/5 border border-[#58007E]/10 rounded-4xl shadow-lg space-y-4 text-center max-w-xl mx-auto"
              >
        ...
        <section className="text-center space-y-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-4xl border border-zinc-100 shadow-sm text-center">
              <p className="text-4xl font-extrabold text-[#58007E] font-serif">
                10K+
              </p>
            ...
            <div className="bg-white p-6 rounded-4xl border border-zinc-100 shadow-sm text-center">
              <p className="text-4xl font-extrabold text-emerald-500 font-serif">
                50+
              </p>
              <p className="text-[10px] font-black uppercase text-zinc-400 tracking-widest mt-2">
                Lessons & Tests
            ...
            <div className="bg-white p-6 rounded-4xl border border-zinc-100 shadow-sm text-center">
              <p className="text-4xl font-extrabold text-amber-500 font-serif">
                98%
              </p>
              <p className="text-[10px] font-black uppercase text-zinc-400 tracking-widest mt-2">
                Satisfaction Rate
            ...
            <div className="bg-white p-6 rounded-4xl border border-zinc-100 shadow-sm text-center">
              <p className="text-4xl font-extrabold text-blue-500 font-serif">
                2.5M+
              </p>
              <p className="text-[10px] font-black uppercase text-zinc-400 tracking-widest mt-2">
                Speech Queries
        ...
        <section className="text-center space-y-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto text-center">
            {[
              {
                icon: Heart,
                t: "Сурагчийн Сэтгэл Ханамж",
                d: "Сурагч хурдан сурах, ахиц гарахад таатай байх хамгийн хэрэглэгч-төвт дизайны үзэлтэй.",
              },
              {
                icon: Shield,
                t: "Чухал Стандартад Тулгуурлах",
                d: "Дасгалууд нь олон улсын CEFR ба IELTS батлагдсан үнэлгээний зааврын дагуу ангилагдсан.",
              },
              {
                icon: Zap,
                t: "Байнгын Шинэчлэл",
                d: "Системийн шийдлүүдийг долоо хоног бүр шинэчилж, хиймэл оюуны нарийвчлалыг нэмэгдүүлдэг.",
              },
            ].map((v, i) => (
              <div
                key={i}
                className="bg-white p-6 rounded-3xl border border-zinc-100 shadow-sm space-y-3 flex flex-col items-center justify-center"
              >
                <div className="w-10 h-10 bg-purple-50 text-[#58007E] rounded-xl flex items-center justify-center mx-auto mb-3">
                  <v.icon size={20} />
                </div>
                <h4 className="text-xs font-black uppercase text-slate-800 text-center">
                  {v.t}
                </h4>
                <p className="text-slate-400 font-bold text-[11px] leading-relaxed text-center">
                  {v.d}
                </p>
              </div>
            ))}
        ...
        <section className="text-center space-y-8 max-w-md mx-auto pt-6">
          ...
          <div className="bg-white p-8 rounded-5xl border border-zinc-100 shadow-sm text-center">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-8 space-y-3 text-center">
                ...
                <p className="text-xs text-gray-400">
                  Бид таны имэйл рүү 24 цагийн дотор хариулах болно.
                </p>
              </div>
            ) : (
              <form
