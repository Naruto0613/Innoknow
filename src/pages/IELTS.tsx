...
export default function IELTS() {
  ...
  const handleSend = async (text: string = input) => {
    ...
    try {
      ...
      const responseText = await generateCustomPrompt(
        prompt,
        systemInstruction,
      );
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 h-[calc(100vh-100px)] flex flex-col gap-6">
      <div className="flex flex-col lg:flex-row gap-8 flex-1 overflow-hidden">
        {/* Chat Area */}
        <div className="flex-1 bg-white rounded-6xl border border-zinc-100 shadow-2xl overflow-hidden flex flex-col relative">
          <div className="p-8 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="font-black text-lg tracking-tight italic font-serif">
                  IELTS Speaking Coach
                </h2>
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
                  <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">
                    Active Session • {profile?.level || "A1"} Level
                  </span>
                </div>
              </div>
            </div>
            <button
              ...
              className="bg-white border border-zinc-100 p-3 rounded-xl text-zinc-400 hover:text-[#58007E] hover:border-[#58007E]/20 transition-all"
            >
              <Trophy size={18} />
            </button>
          </div>
          ...
          <div
            ref={scrollRef}
            className="flex-1 overflow-y-auto p-10 space-y-8 bg-zinc-50/30"
          >
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center max-w-sm mx-auto space-y-8">
                <div className="w-24 h-24 bg-white rounded-5xl shadow-xl flex items-center justify-center text-[#58007E]">
                  <MessageCircle size={48} />
                </div>
                <div>
                  <h3 className="text-2xl font-black italic font-serif mb-3">
                    Ready to practice?
                  </h3>
                  <p className="text-sm text-zinc-500 font-medium">
                    I'm your IELTS examiner. Let's start with Part 1 questions
                    about your hobbies or studies.
                  </p>
                </div>
                <button
                  onClick={() =>
                    handleSend(
                      "Hello, I am ready to start my IELTS speaking practice.",
                    )
                  }
            ...
            <AnimatePresence>
              {messages.map((m, i) => (
                ...
                >
                  <div
                    className={`max-w-[80%] p-6 rounded-4xl shadow-sm ${m.role === "user" ? "bg-[#58007E] text-white border-transparent" : "bg-white text-zinc-800 border border-zinc-100"}`}
                  >
            ...
            {loading && (
              <div className="flex justify-start">
                <div className="bg-white p-5 rounded-3xl border border-zinc-100 shadow-sm flex items-center gap-2">
          ...
          <div className="p-8 bg-white border-t border-zinc-100">
            <div className="relative flex items-center gap-4">
              ...
              <input
                ...
                placeholder={
                  isRecording ? "Listening to you..." : "Share your response..."
                }
        ...
        <div className="w-full lg:w-96 flex flex-col gap-6">
          <div className="bg-[#141414] text-white p-10 rounded-6xl shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex items-end gap-2 mb-8">
              ...
              <span className="text-xs font-black text-zinc-500 uppercase tracking-widest mb-2">
                Estimated
              </span>
            </div>
          ...
          <div className="flex-1 bg-white border border-zinc-100 rounded-6xl p-10 shadow-sm overflow-hidden flex flex-col">
              ...
              {isAnalyzing ? (
                <div className="flex flex-col items-center justify-center h-full text-zinc-300 gap-4">
                  <motion.div
                    ...
                    className="w-8 h-8 border-2 border-[#58007E] border-t-transparent rounded-full"
                  />
                ...
                <div className="h-full flex flex-col items-center justify-center text-center text-zinc-300 gap-4 opacity-50">
                  <HelpCircle size={32} />
                  <p className="text-[10px] font-black uppercase tracking-widest">
                    Ongoing feedback will be provided here.
                  </p>
                </div>
              )}
            </div>
            ...
            <button
              onClick={analyzeProgress}
              className="mt-8 w-full py-4 bg-zinc-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-[#58007E] transition-all flex items-center justify-center gap-2"
            >
