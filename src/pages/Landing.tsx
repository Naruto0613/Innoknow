  ...
  return (
    <div className="overflow-hidden bg-[#FDFCFB]">
      ...
      <section className="relative pt-28 pb-36 px-4 md:px-8 max-w-5xl mx-auto text-center">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-87.5 h-87.5 bg-purple-500/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold leading-[1.05] tracking-tight text-slate-900 font-serif">
            ...
            <span className="text-[#58007E] italic leading-tight">
              INNOKNOW-оор эзэмшинэ.
            </span>
          </h1>
          ...
          <p className="text-sm md:text-base text-slate-500 max-w-2xl mx-auto leading-relaxed font-semibold">
            ...
            бичих дасгалууд. Тэргүүлэгчдийн жагсаалтанд өрсөлдөн ахицаа шууд
            ажигла.
          </p>
      ...
      <section className="bg-white py-24 border-y border-[#14141405]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black mb-3 italic font-serif tracking-tight text-slate-900">
              Манай Давуу Талууд
            </h2>
            <p className="text-slate-400 font-black text-[10px] uppercase tracking-widest">
              Хиймэл оюуны шийдлээр хурдан ахиц
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                icon: MessageSquare,
                title: "AI Ярианы Багш (Speaking Coach)",
                desc: "Таны дуу хоолой болон дуудлагыг сонсонгуут дүрэм болон үгсийн сангийн зөвлөгөөг шууд өгнө.",
                color: "bg-purple-50 text-[#58007E]",
              },
              {
                icon: BarChart3,
                title: "Лидерийн Шат (Real Leaderboard)",
                desc: "Бусад сурагчидтай цуглуулсан XP оноогоор бодит цагт өрсөлдөн, суралцах идэвхээ нэмэгдүүлнэ.",
                color: "bg-emerald-50 text-emerald-600",
              },
              {
                icon: Sparkles,
                title: "50 Сорилт Хичээл",
                desc: "Унших, Сонсох, Бичих, Ярих бүрд 50 бүрэн шалгалт бүхий дадлагыг зөвхөн өөрийн түвшиндээ хийнэ.",
              ...
              >
                <div
                  className={`w-12 h-12 ${feature.color} rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform`}
                >
                  <feature.icon size={22} />
                </div>
                <h3 className="text-sm font-black mb-3 text-slate-900 uppercase tracking-tight text-center">
                  {feature.title}
                </h3>
                <p className="text-slate-500 leading-relaxed text-xs font-semibold text-center">
                  {feature.desc}
                </p>
              </motion.div>
            ))}
      ...
      <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-black mb-3 italic font-serif tracking-tight text-slate-900">
            Бүх Түвшинд Тохирох Сонголтууд
          </h2>
          <p className="text-slate-500 max-w-xl mx-auto font-semibold text-xs md:text-sm leading-relaxed">
            Та анхан шатнаас ахисан шат хүртэлх бүх түвшний хичээлийг сонгож
            үзэх боломжтой.
          </p>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
          {[
            ...
            <div
              key={lvl.tag}
              className="p-6 border border-slate-100 rounded-3xl text-center bg-white shadow-sm hover:border-purple-300 hover:shadow-md transition-all"
            >
      ...
      <section
        id="about-us"
        className="bg-[#FAF9F6] py-24 border-t border-slate-200/50"
      >
        <div className="max-w-5xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 font-semibold text-xs md:text-sm mt-2 max-w-xl mx-auto leading-relaxed">
              Монголын англи хэлний сургалтын стандартыг цоо шинэ түвшинд
              аваачихаар зорин ажиллаж буй манай хөгжүүлэгчид болон багш нартай
              танилцана уу.
            </p>
          </div>
            ...
            {[
              {
                icon: Heart,
                t: "Сурагч Чөхөөтэй",
                d: "Бид хөгжүүлж буй бүх ухаалаг хэрэгслээ сурагчийн хэрэгцээнд хамгийн ээлтэй байлгахаар загварчилдаг.",
              },
              {
                icon: Shield,
                t: "Шинжлэх Ухааны Суурьтай",
                d: "Манай сорилтууд олон улсын IELTS, TOEFL-ийн сорилын стандарт, хэл шинжлэлийн хувийн дүрмүүдэд бат тулгуурладаг.",
              },
              {
                icon: Zap,
                t: "Инновацийн Манлайлал",
                d: "Зөвхөн хамгийн сүүлийн үеийн Gemini AI болон ухаалгаар тохируулсан алгоритмуудыг сургалтанд ашиглаж байна.",
              },
            ].map((st, i) => (
              <div
                key={i}
                className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-3 text-center flex flex-col items-center justify-center"
              >
                ...
                <p className="text-slate-400 font-semibold text-[11px] leading-relaxed text-center">
                  {st.d}
                </p>
              </div>
            ))}
