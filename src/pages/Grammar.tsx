...
const grammarTopics: GrammarTopic[] = [
  // BEGINNER (A1-A2)
  {
    ...
    level: "Beginner",
    explanation:
      'The verb "to be" is the most common verb in English. It is used to describe subjects.',
  ...
  },
  {
    ...
    quiz: [
      {
        question: "He ___ to the gym regularly.",
      ...
      {
        question: "They ___ not live here.",
        options: ["do", "does", "are"],
        correct: 0,
      },
    ],
    ...
    quiz: [
      {
        ...
        options: ["rains", "is raining", "raining"],
        correct: 1,
      },
      {
        question: "What ___ she cooking?",
        options: ["is", "are", "does"],
        correct: 0,
      },
      {
        question: "We ___ studying for the exam.",
        options: ["am", "is", "are"],
        correct: 2,
      },
    ],
  },
  {
    ...
    level: "Intermediate",
    explanation:
      "Connects the past to the present (experience, change over time, or recent action).",
    ...
    quiz: [
      {
        ...
        options: ["lose", "lost", "have lost"],
        correct: 2,
      },
      {
        question: "___ you ever visited Japan?",
        options: ["Have", "Did", "Has"],
        correct: 0,
      },
      {
        question: "She ___ here for five years.",
        options: ["worked", "is working", "has worked"],
        correct: 2,
      },
    ],
  },
    ...
    quiz: [
      {
        ...
        options: ["melts", "will melt", "melted"],
        correct: 0,
      },
      {
      ...
      {
        question: "I would go if I ___ more time.",
  ...
  },
  {
    ...
    level: "Intermediate",
    explanation:
      "Used when the object of the action is more important than the subject.",
    ...
    quiz: [
      {
        question: "The window ___ by the wind.",
        options: ["broke", "is broken", "was broken"],
        correct: 2,
      },
      {
        question: "Millions of emails ___ every day.",
        options: ["send", "is sent", "are sent"],
        correct: 2,
      },
      {
        question: "Our lunch ___ by a chef.",
        options: ["prepares", "is being prepared", "is preparing"],
        correct: 1,
      },
    ],
  },
  ...
  // ADVANCED (C1-C2)
  {
    ...
    level: "Advanced",
    explanation:
      "Used to connect the past and the present (past result of a present condition or vice versa).",
    ...
    quiz: [
      {
        question: "If I ___ the map, we wouldn't be lost now.",
        options: ["didn't forget", "hadn't forgotten", "haven't forgotten"],
        correct: 1,
      },
      {
        question: "He wouldn't be tired if he ___ to bed earlier.",
        options: ["went", "had gone", "has gone"],
        correct: 1,
      },
      {
        question: "If they were rich, they ___ that house earlier.",
        options: ["would buy", "would have bought", "will buy"],
        correct: 1,
      },
    ],
  },
  {
    ...
    level: "Advanced",
    explanation:
      "Reversing the subject and verb to add emphasis or in formal writing.",
    formula: "Negative Adverb + Auxiliary Verb + Subject",
    examples: {
      positive:
        "Never have I seen such a beautiful view. Rarely do we see him.",
    ...
    quiz: [
      {
        question: "Rarely ___ such a good performance.",
        options: ["we see", "do we see", "we do see"],
        correct: 1,
      },
      {
        question: "Under no circumstances ___ the room.",
        options: ["you should leave", "should you leave", "shall you leave"],
        correct: 1,
      },
      {
        question: "Little ___ what was about to happen.",
        options: ["did he know", "he knew", "has he known"],
        correct: 0,
      },
    ],
  },
  {
    ...
    commonMistakes: ["What I need it is help. (Correct: What I need is help)"],
    quiz: [
      {
        question: "It was ___ who found the keys.",
        options: ["I", "me", "my"],
        correct: 1,
      },
      {
        question: "What she loves ___ long walks on the beach.",
        options: ["is", "are", "it is"],
        correct: 0,
      },
      {
        question: "All I wanted ___ a simple apology.",
        options: ["is", "was", "were"],
        correct: 1,
      },
    ],
  },
  {
    ...
    quiz: [
      {
        question: "I suggest that he ___ the meeting.",
        options: ["attend", "attends", "attended"],
        correct: 0,
      },
      {
        question: "It is vital that she ___ about the plan.",
        options: ["know", "knows", "knowing"],
        correct: 0,
      },
      {
        question: "If she ___ more careful, she wouldn't have tripped.",
        options: ["is", "was", "were"],
        correct: 2,
      },
    ],
      ...
      <aside className="w-80 bg-white border-r border-zinc-100 hidden lg:flex flex-col pt-12">
        ...
        <nav className="flex-1 overflow-y-auto px-6 pb-12 space-y-10 scrollbar-hide">
          {["Beginner", "Intermediate", "Advanced"].map((lvl) => (
            <div key={lvl}>
              <h3 className="px-4 text-[10px] font-black uppercase tracking-[0.25em] text-zinc-400 mb-4">
                {lvl}
              </h3>
                ...
                {grammarTopics
                  ...
                  .map((topic) => (
                    ...
                    >
                      ...
                      <ChevronRight
                        size={14}
                        className={`${selectedTopicId === topic.id ? "text-white" : "text-zinc-300 opacity-0 group-hover:opacity-100"}`}
                      />
                    </button>
                  ))}
              </div>
            ...
            <div className="relative">
              ...
              >
                {["Beginner", "Intermediate", "Advanced"].map((lvl) => (
                  <optgroup
                    key={lvl}
                    label={`${lvl === "Beginner" ? "🟢 Beginner" : lvl === "Intermediate" ? "🟡 Intermediate" : "🔴 Advanced"} хэсэг`}
                  >
                    {grammarTopics
                      .filter((t) => t.level === lvl)
                      .map((topic) => (
                  ...
                  {selectedTopic.quiz.map((q, qIdx) => (
                    <div key={qIdx} className="space-y-5">
                      <div className="flex gap-4">
                        <span className="w-8 h-8 rounded-full bg-zinc-100 flex items-center justify-center text-[10px] font-black text-zinc-400 shrink-0">
                          {qIdx + 1}
                        </span>
                        <p className="text-sm font-black text-zinc-800 leading-relaxed pt-1.5">
                          {q.question}
                        </p>
                      </div>
