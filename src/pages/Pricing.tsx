...
export default function Pricing() {
    ...
    return (
      <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
        <p className="text-slate-500 font-bold">
          Уучлаарай, та эхлээд нэвтэрнэ үү.
        </p>
      </div>
    );
  }
  ...
  const refToUse =
    profile.paymentRef ||
    (profile.uid ? "user_" + profile.uid.substring(0, 6) : "user_ref");
  ...
  const plans = [
    ...
    },
    {
      ...
      color:
        "border-[#D9A74A] bg-[#141414] text-white ring-4 ring-[#D9A74A]/20",
      btnText: "Сонгох",
  ...
  const handleSelectPlan = async (planType: "pro" | "premium") => {
    ...
    setPaymentSubmitted(
      profile.paymentStatus === "Pending" && profile.plan === planType,
    );
  };
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 mt-3 max-w-xl mx-auto font-medium text-sm">
            Англи хэлийг илүү хурдан бөгөөд үр дүнтэй сурахын тулд өөрт тохирсон
            премиум төлөвлөгөөг идэвхжүүлээрэй.
          </p>
        </div>
        ...
        {isTrialFinished && (
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            className="mb-10 p-6 bg-amber-50/80 border-2 border-amber-500/20 rounded-4xl max-w-2xl mx-auto flex items-start gap-4 text-left shadow-sm justify-center"
          >
            <div className="p-3 bg-amber-500/10 text-amber-600 rounded-2xl shrink-0">
              <AlertCircle size={24} className="stroke-2 animate-pulse" />
            </div>
            <div>
              <h3 className="text-base font-black text-amber-950 uppercase tracking-tight">
                Таны үнэгүй trial дууслаа
              </h3>
              <p className="text-xs text-amber-800 font-bold mt-1 leading-relaxed">
                Таны 3 хоногийн үнэгүй туршилтын хугацаа амжилттай дууссан тул
                сургалтын систем хаагдсан байна. Үргэлжлүүлэн хязгааргүй
                суралцахын тулд Pro эсвэл Premium багцаас сонгон идэвхжүүлнэ үү.
              </p>
            </div>
          </motion.div>
        )}
          ...
          {!selectedPlan ? (
            ...
            >
              {plans.map((p) => (
                <div
                  key={p.id}
                  className={`relative p-8 rounded-4xl border flex flex-col justify-between transition-all hover:shadow-2xl hover:-translate-y-1 ${p.color}`}
                >
                  {p.badge && (
                  ...
                  <div>
                    ...
                    <p
                      className={`text-xs mb-6 ${p.id === "premium" ? "text-slate-400" : "text-slate-500"} font-medium`}
                    >
                      {p.description}
                    </p>
                    <div className="mb-8">
            ...
            >
              <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-100">
                <div>
                  ...
                  <h2 className="text-2xl font-black font-serif italic text-slate-900">
                    Премиум Идэвхжүүлэх
                  </h2>
                </div>
              ...
              {paymentSubmitted ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-xs text-slate-500 font-medium max-w-md mx-auto leading-relaxed mb-6">
                    Таны төлбөрийн хүсэлтийг хүлээн авлаа. Манай админууд
                    хоёулаа гүйлгээний утгыг (
                    <span className="text-[#58007E] font-black">
                      {refToUse}
                    </span>
                    ) шалгаж баталгаажуулсны дараа таны сургалтын эрх идэвхжих
                    болно.
                  </p>
                  <div className="bg-amber-50 border border-amber-100 px-6 py-4 rounded-2xl max-w-md mx-auto text-left text-[11px] font-semibold text-amber-800 leading-relaxed">
                    ℹ️ <span className="font-bold">Санамж:</span> Давхар админ
                    баталгаажуулалт шаардлагатай тул 24 цаг хүртэлх хугацаа
                    шаардагдаж болно. Идэвхжсэн даруйд имэйлээр мэдэгдэх болно.
                  </div>
                  <button
                ...
                <div className="space-y-6">
                  <div className="p-5 bg-slate-50 rounded-3xl border border-slate-100 flex justify-between items-center">
                    <div>
                      ...
                      <h4 className="text-lg font-bold text-[#58007E]">
                        {selectedPlan === "pro"
                          ? "Pro Plan License"
                          : "Premium VIP Plan"}
                      </h4>
                    ...
                    <div className="text-right">
                      ...
                      <h4 className="text-lg font-black text-slate-900">
                        {selectedPlan === "pro" ? "19,999₮" : "39,999₮"}
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <p className="text-xs font-black text-slate-500 uppercase tracking-widest border-b border-dashed border-slate-200 pb-2">
                    ...
                    <div className="relative group bg-slate-50 hover:bg-[#FDFCFB] p-4 rounded-2xl border border-slate-100 transition-all flex items-center justify-between">
                      <div>
                        ...
                        <span className="text-sm font-black text-slate-800 leading-none">
                          MN330005005035791563
                        </span>
                      </div>
                      <button
                        onClick={() =>
                          copyToClipboard("MN330005005035791563", "bank")
                        }
                        className={`px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all cursor-pointer flex items-center gap-1 ${
                          copied.bank
                            ...
                            : "bg-indigo-50 hover:bg-indigo-100 text-[#58007E]"
                        }`}
                      >
                        {copied.bank ? (
                          "✅ Хуулагдлаа!"
                    ...
                    <div className="relative group bg-slate-50 hover:bg-[#FDFCFB] p-4 rounded-2xl border border-slate-100 transition-all flex items-center justify-between">
                      <div>
                        <span className="text-[10px] text-slate-400 font-bold block uppercase tracking-wider mb-0.5">
                          Гүйлгээний утга (Таны ID)
                        </span>
                        <span className="text-sm font-black text-[#58007E] leading-none">
                          {refToUse}
                        </span>
                      </div>
                      <button
                  ...
                  <div className="bg-amber-50 rounded-3xl p-6 border border-amber-100">
                    <h5 className="text-xs font-black text-amber-900 uppercase tracking-widest mb-3">
                      ⚠️ ЧУХАЛ ЗААВАРЧИЛГАА:
                    </h5>
                    <ul className="space-y-2 text-[11px] font-bold text-amber-800 leading-relaxed list-disc list-inside">
                      ...
                      <li>
                        "Гүйлгээний утганд заавал{" "}
                        <span className="text-[#58007E] font-black decoration-double underline">
                          {refToUse}
                        </span>{" "}
                        гэж бичнэ үү"
                      </li>
                      <li>
                        "Буруу гүйлгээний утга бичвэл төлбөр баталгаажихгүй"
                      </li>
                      <li>
                        "Төлбөр баталгаажихад 24 цаг хүртэл хугацаа шаардагдаж
                        болно"
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row gap-4">
                    ...
                    >
                      {submittingPayment ? (
                        ...
                        <>
                          <CheckCircle2 size={16} /> Би төлбөр төллөө
                        </>
                      )}
                    </button>
                  </div>
