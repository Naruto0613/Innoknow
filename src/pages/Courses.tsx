...
export default function Courses() {
  ...
  const [activeCustomLesson, setActiveCustomLesson] = useState<any | null>(
    null,
  );
  ...
  const handleOpenCustomLesson = (customLesson: any) => {
    ...
    setLessonData({
      ...
      questions:
        customLesson.content?.questions?.map((q: any, idx: number) => ({
          id: `dbq_${idx}`,
    ...
    return (
      <div className="min-h-[calc(100vh-64px)] bg-[#FDFCFB] flex items-center justify-center p-6 text-center">
        <div className="bg-white p-8 md:p-12 rounded-[32px] border border-slate-100 shadow-xl max-w-md w-full">
          ...
          <h2 className="text-2xl font-black font-serif italic text-slate-900 tracking-tight mb-3">
            Инжил Академи
          </h2>
          <p className="text-slate-500 font-semibold text-xs md:text-sm mb-8 leading-relaxed">
            Англи хэлний түвшин тогтоох сорилт болон систем дэх 50 сорилттой
            ажиллахын тулд өөрийн бүртгэлээр нэвтэрч орно уу.
          </p>
          <a
            href="/login"
            ...
            {dbLessons.map((custom) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center gap-1">
                      <span className="text-[9px] font-black uppercase tracking-widest text-[#58007E]">
                        Нэмэлт сорил
                      </span>
                      {isFinished && (
                        <span className="text-[8px] font-black uppercase text-emerald-600 bg-emerald-100 px-1 py-0.5 rounded flex items-center gap-0.5 animate-pulse">
