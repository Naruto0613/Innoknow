...
export default function Courses() {
  ...
  const handleLevelTabChange = async (
    ...
    try {
      ...
      console.warn(
        "Failed to update profile level automatically, fallback local:",
        err,
      );
    }
  };
  ...
  // Launch a Lesson Workbook Modal and fetch custom curriculum
  const handleOpenLesson = async (index: number) => {
    ...
    try {
      ...
      console.warn("Fell back to standard lesson wrapper response:", e);
    } finally {
  ...
  const handleStartSpeakingRecord = () => {
    ...
    if (
      ...
      recObj.onerror = () => {
        setIsRecording(false);
        setSpeakingTranscript(
          "Микрофон алдаатай байна (Англиар ярихад дахин оролдоно уу).",
        );
      };
  ...
  const triggerSpeakingCoach = async (speechText: string) => {
    ...
    try {
      ...
      console.warn(e);
      setSpeakingFeedback(
        "Grammar is robust, vocabulary fits the theme elegantly. Score: 9/10!",
      );
      awardCredit();
    } finally {
  ...
  const triggerWritingCoach = async () => {
    ...
    try {
      ...
      console.warn(e);
      setWritingFeedback(
        "Writing is beautiful and satisfies core parameters! Score: 8.5/10.",
      );
      awardCredit();
    } finally {
  ...
  const awardCredit = async () => {
    if (!activeLessonIndex || !profile) return;

    const token = `${selectedLevel}_${activeTab}_${activeLessonIndex}`;
    ...
    localStorage.setItem(
      "innoknow_completed_lessons_v2",
      JSON.stringify(freshCompleted),
    );
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-[#FDFCFB] py-12 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-slate-100 pb-8">
          <div>
            ...
            <p className="text-slate-500 font-semibold text-xs md:text-sm mt-1 leading-relaxed">
              Түвшин бүрт 50 сорилт хичээл. Хувийн ахицаа хөтөлж, тэргүүлэгчдэд
              нэгдээрэй.
            </p>
          </div>
          ...
          <div className="flex gap-4 bg-white p-4 rounded-3xl border border-slate-100 shadow-md">
            <div className="text-center px-4 border-r border-slate-50">
              ...
              <span className="text-lg font-black text-[#58007E] font-sans">
                {profile.xp || 100} XP
              </span>
            </div>
            <div className="text-center px-4">
              ...
              <span className="text-lg font-black text-slate-800 font-sans">
                {profile.lessonsCompleted || 0} Хичээл
              </span>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
          {[
            ...
            },
            {
              ...
              label: "Сонсох Чадвар",
              desc: "Аялгатай унших дасгалууд",
              icon: Headphones,
              color: "border-l-4 border-l-emerald-500",
            },
            {
              id: "Speaking" as const,
              label: "Ярианы Дадлага",
              desc: "AI дуу хоолой хариу",
              icon: Mic,
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <IconComponent
                    size={20}
                    className={
                      isTabActive ? "text-[#58007E]" : "text-slate-400"
                    }
                  />
                </div>
                <h4 className="text-xs font-extrabold text-slate-900 group-hover:text-[#58007E] transition-colors">
                  {sc.label}
                </h4>
        ...
        <div className="bg-white rounded-5xl border border-slate-100 shadow-xl p-6 md:p-10 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-h-200 overflow-y-auto pr-2 scrollbar-none">
            {Array.from({ length: 50 }, (_, i) => i + 1).map((idx) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-xl shrink-0 flex items-center justify-center font-bold text-xs uppercase ${
                      isFinished
                        ...
                        <div>
                          ...
                          {lessonData.translationCue && (
                            <div className="mt-3 p-4 bg-purple-50/40 rounded-2xl border border-purple-100/50 text-xs text-slate-500">
                              <span className="font-bold text-[#58007E] block mb-1">
                                🇲🇳 Сурлагын зөвлөгөө / Монгол орчуулга тусламж:
                              </span>
                              {lessonData.translationCue}
                            </div>
                          )}
                        ...
                        lessonData.questions && (
                          <div className="space-y-6">
                            <h3 className="text-xs font-black uppercase tracking-widest text-slate-400 flex items-center gap-1 border-t border-slate-100 pt-6">
                              <HelpCircle size={14} /> Текстэд суурилсан шалгалт
                              (Little Test)
                            </h3>
                                  ...
                                  {q.options.map((option) => {
                                    ...
                                    if (testChecked) {
                                      if (isCorrectAnswer) {
                                        ...
                                        optionStyle =
                                          "border-red-400 bg-red-50/40 text-red-800";
                                      }
                                    } else if (isSelected) {
                                      optionStyle =
                                        "border-[#58007E] bg-purple-50/30 text-[#58007E]";
                                    }
                            ...
                            {!testChecked ? (
                              ...
                              <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 text-center space-y-3">
                                <h4 className="text-sm font-extrabold text-slate-800">
                                  Шалгалтын үр дүн: {testScore?.correct} /{" "}
                                  {testScore?.total} зөв
                                </h4>
                                {testScore && testScore.correct >= 2 ? (
                                  <p className="text-xs text-emerald-600 font-bold">
                                    🥇 Шалгалтанд тэнцлээ! Танд +50 XP оноо шууд
                                    орлоо.
                                  </p>
                                ) : (
                                  <div className="space-y-2">
                                    <p className="text-xs text-red-500 font-bold">
                                      Шалгалтанд тэнцэхэд дор хаяж 2 зөв
                        ...
                        <div className="space-y-6">
                          <div className="p-6 bg-purple-50 border border-purple-100 rounded-3xl space-y-3">
                            ...
                            <p className="text-xs text-slate-600 font-semibold leading-relaxed">
                              Дор байрлах микрофон товчлуур дээр дараад тухайн
                              сэдвийн хүрээнд Англи хэл дээр өөрийн бодлыг
                              чөлөөтэй илэрхийлж яриарай. Бидний хиймэл оюун
                              ухаан таныг сонсоод шууд дүрэм, үгсийн сангийн
                              зөвлөгөөг өгөх болно.
                            </p>
                          </div>

                          <div className="bg-white p-8 rounded-4xl border border-slate-100 shadow-md text-center space-y-4">
                            <span className="text-[10px] uppercase font-black tracking-widest text-[#58007E] block">
                              Дуу хоолой бичих
                            </span>
                            <button
                            ...
                            <p className="text-xs text-slate-400 font-bold max-w-sm mx-auto">
                              Товчийг дараад утас эсвэл компьютер руугаа Англиар
                              ярина уу.
                            </p>
                          </div>
                          ...
                          {speakingTranscript && (
                            <div className="p-5 bg-slate-50 rounded-2xl border border-slate-200/60">
                              ...
                              <p className="text-sm font-semibold italic text-[#58007E] mt-1">
                                "{speakingTranscript}"
                              </p>
                            </div>
                          )}
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="bg-slate-50 border border-slate-200/60 rounded-3xl p-6 space-y-4">
                            <h4 className="text-xs font-extrabold text-[#58007E] uppercase tracking-wider flex items-center gap-1.5">
                              <Sparkles size={14} /> ESSAY STRUCTURE GUIDE /
                              ЭССЭНИЙ ЗӨВ БҮТЭЦ
                            </h4>
                            <p className="text-xs text-slate-600 leading-relaxed">
                              Англи хэлний эссэ бичихдээ дараах 3 гол бүтэц,
                              дүрмийг анхаарна уу. Энэ нь таны бичих чадварыг
                              олон улсын шалгалтанд бэлдэнэ.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-2">
                              <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm space-y-1">
                                ...
                                <p className="text-[10.5px] font-semibold text-slate-500 leading-normal">
                                  Сэдвээ танилцуулж, өөрийн үндсэн үзэл санааг
                                  (Thesis statement) маш тодорхой ганц өгүүлбэрт
                                  илэрхийлнэ.
                                </p>
                              </div>
                              <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm space-y-1">
                                <span className="text-[10px] font-black uppercase text-purple-600 block">
                                  2. Body Paragraph (60-75%)
                                </span>
                                <p className="text-[10.5px] font-semibold text-slate-500 leading-normal">
                                  Санаагаа нотлох аргументууд, жишээ, тайлбар
                                  (PEEL бүтэц: Point, Evidence, Explanation,
                                  Link).
                                </p>
                              </div>
                              <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm space-y-1">
                                ...
                                <p className="text-[10.5px] font-semibold text-slate-500 leading-normal">
                                  Үндсэн санаагаа өөр үгээр давтан дүгнэж
                                  (Restate thesis), уншигчид үлдэх тунгаах
                                  бодлоор дуусгана.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="space-y-4">
                            <span className="text-[10px] font-black text-slate-400 block uppercase">
                              Англиар бичих талбар (Эссэ хэсэг):
                            </span>
                            <textarea
