...
export default function Navbar() {
  ...
  const battleItems = [
    ...
    {
      name: "Battle Arena",
      desc: "Дуэлийн сонирхолтой талбар",
      path: "/battle",
      icon: Swords,
  ...
  const Logo = () => (
    ...
    >
      <div className="w-10 h-10 flex items-center justify-center transition-transform group-hover:scale-105">
        {useCustomImageLogo ? (
          <img
            ...
            onError={(e) => {
              console.warn(
                "Custom logo image could not be loaded from: " + logoImageSrc,
              );
            }}
          />
        ) : (
      ...
      <span className="font-bold text-2xl tracking-tighter text-zinc-900 italic font-serif">
        INNOKNOW
      </span>
    </Link>
  );
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          >
            <button className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-widest text-zinc-500 hover:text-[#58007E] transition-all py-2 cursor-pointer">
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-200 ${activeMenu === "lessons" ? "rotate-180 text-[#58007E]" : ""}`}
              />
            </button>
            <AnimatePresence>
              {activeMenu === "lessons" && (
                    ...
                    >
                      ...
                      <div className="text-left">
                        <div className="flex items-center gap-1.5">
                          <span className="text-[11px] font-black uppercase tracking-wider text-slate-800 group-hover:text-[#58007E] transition-colors">
                            {item.name}
                          </span>
                          {item.hot && (
                            <span className="px-1.5 py-0.5 bg-rose-500 text-white text-[7px] font-black rounded uppercase tracking-wider">
                              Hot
                            </span>
                          )}
                        </div>
          ...
          >
            <button className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-widest text-zinc-500 hover:text-[#58007E] transition-all py-2 cursor-pointer">
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-200 ${activeMenu === "battle" ? "rotate-180 text-[#58007E]" : ""}`}
              />
            </button>
            <AnimatePresence>
              {activeMenu === "battle" && (
                    ...
                    >
                      ...
                      <div className="text-left">
                        <div className="flex items-center gap-1.5">
                          ...
                          {item.live && (
                            <span className="px-1.5 py-0.5 bg-emerald-500 text-white text-[7px] font-black rounded uppercase tracking-wider animate-pulse">
                              Live
                            </span>
                          )}
                        </div>
          ...
          >
            <button className="flex items-center gap-1.5 text-[11px] font-black uppercase tracking-widest text-[#58007E] hover:text-[#40005C] transition-all py-2 cursor-pointer">
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-200 ${activeMenu === "extras" ? "rotate-180 text-[#58007E]" : ""}`}
              />
            </button>
            <AnimatePresence>
              {activeMenu === "extras" && (
          ...
          {user && isUserAdmin(user) && (
            <Link
              to="/admin"
              className="text-[10px] font-black uppercase tracking-widest text-amber-600 hover:text-amber-700 bg-amber-50 px-3 py-1.5 rounded-lg border border-amber-100 flex items-center gap-1.5"
            >
          ...
          {user ? (
            <div className="flex items-center gap-6 border-l border-zinc-100 pl-8 ml-2">
              <div className="flex flex-col items-end">
                ...
                <span className="text-[10px] font-black text-[#58007E] uppercase tracking-widest">
                  {profile?.level || "A1"} Level
                </span>
              </div>
              <Link
                to="/dashboard"
                className="p-2.5 bg-zinc-50 text-zinc-400 hover:text-[#58007E] hover:bg-white hover:shadow-xl rounded-xl transition-all"
              >
            ...
            <div className="flex items-center gap-4 ml-4">
              <Link
                to="/login"
                className="text-[10px] font-black text-zinc-500 hover:text-zinc-900 uppercase tracking-widest"
              >
                Sign In
              </Link>
              <Link
                to="/signup"
                className="text-[11px] font-black bg-[#58007E] text-white px-8 py-3.5 rounded-2xl hover:bg-[#40005C] transition-all shadow-xl shadow-[#58007E]/20 uppercase tracking-widest"
              >
                Join Now
              </Link>
            </div>
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-200 ${mobileLessonsOpen ? "rotate-180" : ""}`}
              />
            </button>
            {mobileLessonsOpen && (
                  ...
                  >
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        {item.hot && (
                          <span className="px-1 py-0.2 bg-rose-500 text-white text-[6px] font-black rounded uppercase">
                            Hot
                          </span>
                        )}
                      </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-200 ${mobileBattleOpen ? "rotate-180" : ""}`}
              />
            </button>
            {mobileBattleOpen && (
              <div className="grid gap-2 pl-1.5">
                  ...
                  >
                    ...
                    <div>
                      <div className="flex items-center gap-1.5">
                        ...
                        {item.live && (
                          <span className="px-1 py-0.2 bg-emerald-500 text-white text-[6px] font-black rounded uppercase animate-pulse">
                            Live
                          </span>
                        )}
                      </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              ...
              <ChevronDown
                size={14}
                className={`transition-transform duration-200 ${mobileExtrasOpen ? "rotate-180" : ""}`}
              />
            </button>
            {mobileExtrasOpen && (
              <div className="grid gap-2 pl-1.5">
              ...
              <>
                ...
                >
                  <div className="flex flex-col text-left">
                    ...
                    <span className="text-[10px] font-black text-[#58007E] uppercase tracking-widest mt-0.5">
                      {profile?.level || "A1"} Level
                    </span>
                  </div>
